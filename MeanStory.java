...
public class MeanStory {
    public static List<Dialogue> getStory() {
        ...
        // ตัวเลือกตัดสินใจตอนจบ (Index 8) ---มาแก้ด้วยยยง
        ...
        list.add(new Dialogue("คุณ", "“ เราก็รู้สึกเหมือนกันนะ  ”", "res/BGLibrary.jpg|res/Givebook.png")); // [cite: 6, 7]
            new String[]{"งั้นต่อไป...ขออยู่ข้างๆแบบนี้ทุกวันได้ไหม", "เราก็ดีใจนะ ที่มีเธอเป็ฯเพื่อนอ่านหนังสือ  , "ขอโทษนะ ชหลังจากนี้เราอาจไม่ได้ม่บ่อยๆแล้ว"},
